    ...
    return (
      <div>
        ...
        <div>
          ...
          <p className="container text-center  shadow-lg p-3 mb-5 bg-body rounded" style={{ color: "navy" }}>We appreciate you visiting our website.
           Please use the feedback form below if you have any comments about any page on www.elearning.com.</p>
          </div>
          ...
          <div class="container contact-container">
            <section class=" container">
              <p
                ...
                style={{ color: "navy" }}
              >
                We are grateful that you came to our
                 website. Please use this form to provide 
                 feedback regarding your visit, the site's content, or to report any broken links. Your suggestions and comments are appreciated.
              </p>
        ...
        <Card>
              ...
              <Card.ImgOverlay className="text-light d-flex justify-content-center align-items-center">
                <a href="https://wa.me/233553311567" className="text-decoration-none text-light" target={"_blank"}>
                <p className="p-3 rounded-pill fw-bold shadow-lg  mb-5 "  style={{backgroundColor:"navy" ,cursor:"pointer"}}>
