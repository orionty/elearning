          ...
          <ol>
            ...
            <li>
              <p>
                ...
                network is called as __________.
                <br />
                a. Client
                <br />
                b. Server
            ...
            <li>
              <p>
                Machine that places the request to access the data is generally
            ...
            <li>
              <p>
                The client–server model is an approach to computer network
                programming developed at __________.
                <br />
                a. AT&T Bell Lab
                <br />
                b. Xerox PARC
            ...
            <li>
              <p>
                The time taken by a packet to travel from client to server and
                then back to the client is called ____
                <br />
                a. STT
                <br />
                b. RTT
            ...
            <li>
              <p>
                In the process of fetching a web page from a server the HTTP
                request/response takes ______ RTTs.
                <br />
                a. 2<br />
                b. 1<br />
                c. 4<br />
