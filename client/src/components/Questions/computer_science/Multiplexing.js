      ...
      <div className="container-fluid mt-5 mb-5 p-3">
        ...
        <div>
          <ol>
            ...
            <li>
              <p>
                The sharing of a medium and its link by two or more devices is
                called _________
                <br />
                a. Fully duplexing
                <br />
            ...
            <li>
              <p>
                In TDM, the transmission rate of a multiplexed path is always
                _______ the sum of the transmission rates of the signal sources.
                <br />
                a. Greater than
                <br />
                b. Lesser than
                    ...
                    overlay={
                      ...
                      >
                        <Popover.Body>
                          <div className="container-fluid  p-1 mb-1 ">
                            <p>
                              Answer: (d) <br /> Both Efficiency & Privacy
                            </p>
                          </div>
                        </Popover.Body>
                      </Popover>
            ...
            <li>
              <p>
                If link transmits 4000frames per second, and each slot has 8
                bits, the transmission rate of circuit this TDM is _________
                <br />
                a. 32kbps
                <br />
                b. 500bps
            ...
            <li>
              <p>
                If there are n signal sources of same data rate, then the TDM
            ...
            <li>
              <p>
                ...
                <br />
                a. channel <br/>b. receiver site <br/>c. sender site <br/>d. packet
              </p>
              <>
                {["bottom"].map((placement) => (
                  <OverlayTrigger
